...
export function Display({ children, className }: Readonly<TextProps>) {
  return (
    <h1
      className={cn(
        "text-[32px] font-bold leading-[39px] lg:text-[46px] lg:leading-[57px] 2xl:text-[54px] 2xl:leading-[66px]",
        className
      )}
    >
      {children}
...
export function P({ children, className, ...props }: Readonly<TextProps>) {
  return (
    <p
      className={cn(
